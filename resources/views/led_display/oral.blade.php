                ...
                <div class="row mb-3 justify-content-center align-items-center">
                    ...
                    <div class="col-md-10 d-flex align-items-center">
                        ...
                        <div class="col-md-9 fw-bold" style="font-size: {{ $font[$index] }}; color:{{ $color[$index] }};">
                            <button type="button" class="btn show-poster fw-bold" data-bs-toggle="modal" data-bs-target="#fullscreenModal{{ $item->id }}" style="color: {{ $color[$index] }}; text-decoration: none; font-size: {{ $font[$index] }};">
