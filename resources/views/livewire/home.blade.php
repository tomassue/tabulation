        ...
        <div class="card-body text-center p-5">
            ...
            <div class="row g-3 justify-content-center">
                ...
                <div class="col-12 col-md-4">
                    <a href="{{ route('event', $item->category) }}"
                        class="btn btn-{{ $colors[$index % count($colors)] }} w-100 py-3 fw-semibold shadow-sm d-flex justify-content-between align-items-center btn-auto-size">
                ...
                <div class="col-12 col-md-4">
                    <a href="{{ route('logout') }}"
                        class="btn btn-dark w-100 py-3 fw-semibold shadow-sm"
