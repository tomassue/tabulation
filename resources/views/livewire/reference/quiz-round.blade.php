                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="toolbar mb-3 d-flex justify-content-end">
                                            <button type="button" class="btn btn-primary" wire:click="addRound">
                                                <div wire:loading.remove wire:target="addRound">
                                                    Add
                                                </div>
                                                <div wire:loading wire:target="addRound">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-sm btn-primary" wire:click="editRound({{$item->id}})">
                                                                <div wire:loading.remove wire:target="editRound({{$item->id}})">
                                                                    Edit
                                                                </div>
                                                                <div wire:loading wire:target="editRound({{$item->id}})">
                                                                    <div class="spinner-border spinner-border-sm" role="status">
                                                                        <span class="visually-hidden">Loading...</span>
                                                                    </div>
                                                                </div>
