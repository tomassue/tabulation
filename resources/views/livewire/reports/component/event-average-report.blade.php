<div>
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Average Report Content (Multiple Events)</h5>
            <div class="row">
                <div class="col-lg-6">
    ...
    <div class="modal fade" id="reportAverageModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true" wire:ignore.self>
...
@script
    <script>
        window.addEventListener('openAverageModal', event => {
            var myModal = new bootstrap.Modal(document.getElementById('reportAverageModal'));
            myModal.show();
        });
    </script>
@endscript
