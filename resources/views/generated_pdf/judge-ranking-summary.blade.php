            ...
            <tr>
                ...
                <td style="vertical-align: top;" width="85%">
                    <div style="text-align: center;padding-top:20px;padding-bottom:20px;">
                        <div style="font-size: 20pt;font-weight:bold;">Scoring Sheet</div>
                        <div style="font-size: 15pt;text-transform: uppercase;color: #266da7;">{{ $category->description }} (<span style="color: red;">50%</span>)</div>
                    </div>
